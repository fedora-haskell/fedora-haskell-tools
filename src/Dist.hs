...
--sidetag (Fedora n) | n >= 33 = Just "build-side-19539"
sidetag _ = Nothing

-- | Maps `Dist` to build tag
distTag :: Dist -> String
--distTag (Fedora n) | n >= 33 = "f33-build-side-19539"
distTag d = show d ++ "-" ++ fromMaybe "build" (sidetag d)

-- | Maps `Dist` to target tag
distTarget  :: Dist -> String
--distTarget (Fedora n) | n >= 33 = "f33-build-side-19539"
